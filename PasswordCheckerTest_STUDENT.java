...
public class PasswordCheckerTest_STUDENT {
    ...
    public void testIsValidPasswordTooShort() {
        try{
            assertTrue(PasswordCheckerUtility.isValidPassword("chd12"));
        }
    ...
    public void testIsWeakPassword() {
        try{
            assertTrue(PasswordCheckerUtility.isWeakPassword("Chd04#"));
        }
    ...
    public void testIsValidPasswordInvalidSequence() {
        try{
            assertTrue(PasswordCheckerUtility.isValidPassword("ccHD45#"));
        }
    ...
    public void testIsValidPasswordNoDigit() {
        try{
            assertTrue(PasswordCheckerUtility.isValidPassword("chdChd"));
        }
    ...
    public void testIsValidPasswordSuccessful()
    {
        try 
        {
            assertTrue(PasswordCheckerUtility.isValidPassword("Ch0045#"));    
        }
        catch(Exception e) 
        {
    ...
    public void testInvalidPasswords() {
        ...
        assertEquals(scan.next(), "CHD#9090");
		String next = scan.nextLine().toLowerCase();
		
		scan = new Scanner(results.get(1));  
		assertEquals(scan.next(), "Chris45!");
